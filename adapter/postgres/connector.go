...
// OpenConnection return sonnection pool from postgres drive PGX
func OpenConnection(context context.Context) *pgxpool.Pool {
...
// RunMigrations run scripts on patch database/migrations
func RunMigrations() {
	databaseURL := viper.GetString("database.url")
